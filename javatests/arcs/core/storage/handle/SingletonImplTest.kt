...
class SingletonImplTest {
    ...
    private lateinit var mockStorageEndpoint:
        StorageCommunicationEndpoint<CrdtSingleton.Data<MockDataItem>,
            CrdtSingleton.IOperation<MockDataItem>, MockDataItem?>
    @Mock
    private lateinit var mockStorageEndpointProvider:
        StorageCommunicationEndpointProvider<CrdtSingleton.Data<MockDataItem>,
            CrdtSingleton.IOperation<MockDataItem>, MockDataItem?>
    ...
    fun setUp() {
        ...
        val syncMsg = ProxyMessage.ModelUpdate<CrdtSingleton.Data<MockDataItem>,
            CrdtSingleton.IOperation<MockDataItem>, MockDataItem?>(
            model = CrdtSingleton.DataImpl(), id = null)
