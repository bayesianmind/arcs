...
class CollectionImplTest {
    ...
    @Mock private lateinit var mockStorageEndpoint:
        StorageCommunicationEndpoint<CrdtSet.Data<MockDataItem>, CrdtSet.IOperation<MockDataItem>,
            Set<MockDataItem>>
    @Mock private lateinit var mockStorageEndpointProvider:
        StorageCommunicationEndpointProvider<CrdtSet.Data<MockDataItem>,
            CrdtSet.IOperation<MockDataItem>, Set<MockDataItem>>
    ...
    fun setUp() {
        ...
        val makeProxySynced = ProxyMessage.ModelUpdate<CrdtSet.Data<MockDataItem>,
            CrdtSet.IOperation<MockDataItem>, Set<MockDataItem>>(
            model = CrdtSet.DataImpl(), id = null)
